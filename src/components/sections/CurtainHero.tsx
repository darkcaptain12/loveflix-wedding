...
export default function CurtainHero() {
  ...
  useEffect(() => {
    ...
    tl.to(els[0], { opacity: 0.5, y: 0, duration: 0.6 })
      ...
      .to(els[5], { opacity: 0.3, y: 0, duration: 0.5 }, '-=0.1');
    return () => { tl.kill(); };
  }, []);

  return (
    <section className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden" style={{ background: '#000' }}>
      {/* Curtain left */}
      <div className="absolute inset-y-0 left-0 w-[42%] z-0" style={{
        ...
        <div className="absolute inset-0" style={{
          background: 'repeating-linear-gradient(90deg, transparent, transparent 16px, rgba(0,0,0,0.12) 16px, rgba(0,0,0,0.12) 18px)',
        }} />
      ...
      <div className="absolute inset-0 z-[1]" style={{
        background: 'radial-gradient(ellipse 60% 40% at 50% -5%, rgba(255,255,255,0.04) 0%, transparent 100%)',
      }} />

      {/* Warm spotlight */}
      <div className="absolute inset-0 z-[1]" style={{
        background: 'radial-gradient(circle at 50% 45%, rgba(229,9,20,0.03) 0%, transparent 50%)',
      }} />
      ...
      <div ref={contentRef} className="relative z-10 flex flex-col items-center text-center px-8">
        <p className="text-[0.6rem] tracking-[0.4em] text-white/50 uppercase mb-4 font-light">
          Bir Orijinal Yapım
        </p>
        <h1 className="font-heading text-accent text-[3.5rem] tracking-[0.15em] leading-none mb-3">
          LOVEFLIX
        </h1>
        <p className="text-[0.55rem] tracking-[0.35em] text-white/30 uppercase mb-8 font-light">
          sunar
        </p>
        ...
        <p className="text-accent font-heading text-xl tracking-[0.2em] mt-6">
          29.08.2026
        </p>
        <div className="mt-14 flex flex-col items-center gap-3">
          ...
          <span className="text-[0.5rem] tracking-[0.4em] text-white/20 uppercase font-light">
            Kaydırın
          </span>
        </div>
      </div>
